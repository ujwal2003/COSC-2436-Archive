...
for casenum in `seq 1 1 9`; do
	timeout -k 2s 2s ./$cmd "input=input${hwnumber}${casenum}.txt;sort=sort${hwnumber}${casenum}.txt;output=output${hwnumber}${casenum}.txt" 1>${casenum}.stdcout 2>${casenum}.stderr
